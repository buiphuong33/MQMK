...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--perfect_match', default=False, type=str2bool)
    subparsers.add_argument('--multi_query', default=True, type=str2bool)
    subparsers.add_argument('--multi_key', default=True, type=str2bool)
    subparsers.add_argument('--k_key', default=5, type=int)
    subparsers.add_argument('--NCM', default=False, type=str2bool)
    subparsers.add_argument('--KEY_replace', default=False, type=str2bool)
    # subparsers.add_argument('--Match_KEY_replace', default=False, type=str2bool)
    subparsers.add_argument('--Match_NCM', default=False, type=str2bool)
    subparsers.add_argument('--class_group', default=1, type=int)
    subparsers.add_argument('--name', default=time.strftime("%m%d-%H%M%S"), type=str, help='Name of the experiment')
    ...
    subparsers.add_argument('--gpu_devices', default='0,1'   , type=str, help='gpu devices for training')
