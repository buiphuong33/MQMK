...
def parse_args():
    ...
    if config == 'cifar100_dualprompt':
        ...
        from MQMK.configs.mqmk import get_args_parser
    ...
    config_parser.add_argument("--nodes", default=1, type=int, help="Number of nodes to request")
...
def main():
    ...
    executor.update_parameters(name="dualprompt")
