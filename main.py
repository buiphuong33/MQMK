...
def main(args):
    ...
    model = create_model(
        ...
        using_new_classifier=args.KEY_replace or args.NCM or args.Match_NCM,
    )
...
if __name__ == '__main__':
    ...
    # print('----------------------------')
    # print('args.multi_query:', args.multi_query)
    # print('args.multi_key:', args.multi_key)
    # print('----------------------------')
    # debug
    # args.device = 'cpu'
